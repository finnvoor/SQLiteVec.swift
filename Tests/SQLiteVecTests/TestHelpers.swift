...
let bool = SQLiteVec.Expression<Bool>("bool")
let boolOptional = SQLiteVec.Expression<Bool?>("boolOptional")

let data = SQLiteVec.Expression<Blob>("blob")
let dataOptional = SQLiteVec.Expression<Blob?>("blobOptional")

let date = SQLiteVec.Expression<Date>("date")
let dateOptional = SQLiteVec.Expression<Date?>("dateOptional")

let double = SQLiteVec.Expression<Double>("double")
let doubleOptional = SQLiteVec.Expression<Double?>("doubleOptional")

let int = SQLiteVec.Expression<Int>("int")
let intOptional = SQLiteVec.Expression<Int?>("intOptional")

let int64 = SQLiteVec.Expression<Int64>("int64")
let int64Optional = SQLiteVec.Expression<Int64?>("int64Optional")

let string = SQLiteVec.Expression<String>("string")
let stringOptional = SQLiteVec.Expression<String?>("stringOptional")

let uuid = SQLiteVec.Expression<UUID>("uuid")
let uuidOptional = SQLiteVec.Expression<UUID?>("uuidOptional")
